...
from qgis_epanet_integrator.elements import ModelLayer, ModelOptions, ResultLayer
...
if TYPE_CHECKING:  # pragma: no cover
    import wntr
LOGGER = logging.getLogger("qgis_epanet_integrator")
...
class CommonProcessingBase(QgsProcessingAlgorithm):
    ...
    def helpUrl(self) -> str:  # noqa: N802
        return "https://github.com/EllibreMK/EBQEPA"
