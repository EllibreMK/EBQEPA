...
import qgis_epanet_integrator as integrator
import qgis_epanet_integrator.expressions
from qgis_epanet_integrator.dependencies import CheckAndFetchEpanetTask
from qgis_epanet_integrator.elements import FlowUnit, HeadlossFormula, ModelLayer, ResultLayer
...
VERSION_SETTING = "qgis_epanet_integrator/version"

LOGO_ICON = QIcon("qgis_epanet_integrator:logo.svg")
...
class Plugin:
    ...
    def setup_actions(self) -> None:
        ...
        self.model_validation_action = QAction(
            QgsApplication.getThemeIcon("mActionCheckGeometry.svg"),
            tr("Sprawdź model"),
            self.object,
        )
    ...
    def show_welcome_message(self):
        ...
        QgsSettings().setValue(VERSION_SETTING, integrator.__version__)

        if old_version == integrator.__version__:
            return
    ...
    def _append_console_statements(self) -> None:
        ...
        with contextlib.suppress(ModuleNotFoundError, AttributeError):
            ...
            console.console_sci._init_statements.extend(["import qgis_epanet_integrator"])  # noqa: SLF001
...
class LoadExampleAction(LoadInpAction):
    ...
    def get_filepath(self) -> str:
        return integrator.examples["KY10"]
